...
'Porci�n de pollo a la brasa acompa�ada de papas fritas y ensalada fresca',
24.90,
1
...
'Media porci�n de pollo con papas y ensalada',
45.90,
1
FROM categoria_producto
WHERE nombre='Pollos';
...
'Pollo entero acompa�ado de papas familiares y ensalada',
78.90,
1
FROM categoria_producto
WHERE nombre='Pollos';
...
'Combinaci�n de pollo, carne y acompa�amientos',
42.90,1
FROM categoria_producto
...
'Tradicional peruano',
'Brochetas acompa�adas de papas',
22.90,1
FROM categoria_producto
WHERE nombre='Parrillas';
...
INSERT INTO producto
(id_categoria,nombre,desc_corta,desc_completa,precio,requiere_preparacion)
SELECT id_categoria,'Crema Aj�',
'Salsa especial',
'Crema artesanal de aj�',
3.90,0
FROM categoria_producto
WHERE nombre='Adicionales';
...
'Postre cl�sico',
'Bizcocho h�medo con tres leches',
12.90,0
FROM categoria_producto
